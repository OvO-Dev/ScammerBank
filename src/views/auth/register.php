...
<head>
  ...
  <title><?=CFG::bank_name ?> - Register</title>
        ...
        <div class="row">
          <div class="col">
            <div class="p-5">
              ...
              <div class="text-center">
                <a class="small" href="<?=URL::auth_login ?>">Already have an account? Login!</a>
              </div>
              <hr>
              <div class="text-center">
                <p>Notice: We need more infos after this registration!</p>
              </div>
            </div>
          </div>
        </div>
